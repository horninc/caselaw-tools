...
setup(
    ...
    description='Python toolkit for working with case law',  # Optional
    ...
    # project.
    author='Kristaps Horns',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='k.horns@ideaspool.nl',  # Optional
    ...
    keywords='caselaw tools cjeu',  # Optional
